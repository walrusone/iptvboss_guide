...
The redesigned editor adapts its panels as the window is resized. Four panels can be adjusted independently: **Channel Options**, **Basic Info**, **EPG Mapping**, and **Group Options**. Select a panel header to expand or collapse it; IPTVBoss remembers these choices between uses.
