...
The proxy must forward HTTPS requests and preserve the appropriate forwarded headers. `IPTVBOSS_XC_TRUSTED_PROXIES` can restrict which proxy addresses are allowed to provide forwarded client information; see [Proxy trust](runtime.md#proxy-trust).
