...
Open **Settings** → **Server Settings** in the desktop IPTVBoss application. These settings connect the desktop installation to the browser-based XC Server Dashboard.
