...
After activating Pro, restart IPTVBoss if requested and confirm that the lock icons have been removed. Existing Free-plan data remains available after an upgrade; Pro expands what can be added, generated, or synchronized.

!!! note
    Subscription tiers, account limits, and feature availability can change. If the application shows a different limit or a locked control, use the current account status and menu label as the source of truth.
