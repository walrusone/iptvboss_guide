...
If you have an IPTVBoss Pro subscription, open [IPTVBoss Pro Settings](../settings/pro.md) to enter or activate the credentials supplied with your account. Pro-only controls may remain locked until the account is validated.
