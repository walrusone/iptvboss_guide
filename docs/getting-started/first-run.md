...
If you have an IPTVBoss Pro subscription, follow [IPTVBoss Pro Account Access](../settings/pro.md) to enter or activate the credentials supplied with your account. Pro-only controls may remain locked until the account is validated.
